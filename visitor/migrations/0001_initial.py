    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifie', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['read'], name='visitor_not_read_d8f8b4_idx'),
        ),
        migrations.AddIndex(
            model_name='notifications',
            index=models.Index(fields=['content_type', 'objet_id'], name='visitor_not_content_6eb3c4_idx'),
        ),
    ]
